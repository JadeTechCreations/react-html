...
var _noop = __webpack_require__(97);
...
var _rules = __webpack_require__(35);
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          errorClassName = _props.errorClassName,
          className = _props.className,
          rest = _objectWithoutProperties(_props, ['containerClassName', 'errorClassName', 'className']);
...
var _inputFactory = __webpack_require__(34);
...
var FileInput = function (_Component) {
  ...
  function FileInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FileInput.__proto__ || Object.getPrototypeOf(FileInput)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {

      // this.props.value = event.target.files[0];
      var fileName = event.target.value.replace(/^.*[\\\/]/, '');

      var label = event.target.parentElement.nextElementSibling,
      ...
      _this.props.value.push(event.target.files[0]);
  ...
  _createClass(FileInput, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          hint = _props.hint,
          name = _props.name,
          rest = _objectWithoutProperties(_props, ['containerClassName', 'hint', 'name']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            { htmlFor: this.props.name, className: 'button', style: { margin: 0 } },
            'Upload File'
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('span', { className: 'uploadText' })
          )
        ),
        _react2.default.createElement(
          'div',
...
exports.default = (0, _inputFactory2.default)(FileInput);
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: containerClassName },
        _react2.default.createElement('input', _extends({}, rest, _defineProperty({
          type: 'file',
...
var _selectFactory = __webpack_require__(95);
...
exports.default = (0, _inputFactory2.default)(Text);
...
var _file = __webpack_require__(90);
...
var ReactDOMServer = __webpack_require__(134);
var ReactIsomorphic = __webpack_require__(141);
...
var DOMProperty = __webpack_require__(15);
var ReactDefaultPerfAnalysis = __webpack_require__(137);
var ReactMount = __webpack_require__(5);
var ReactPerf = __webpack_require__(7);
